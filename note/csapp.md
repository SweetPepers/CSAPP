...
![](../picture/elf_o.png)![](../picture/elf_h.png)
...
首部是magic number
![](../picture/magic_num.png)


### 10 链接EOF节头表 Section hearder Table
- 指令`readelf -S elf.o`
  ![](../picture/readelf-S.png)
...
![](../picture/10ELF节头表.png)


### 11 链接-符号表 symbol table
- 指令`readelf -s elf.o` 
  ![](../picture/readelf-symtabl.png)
